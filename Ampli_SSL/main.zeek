...
export {
        ...
        type Info: record {
                ...
                # -- &log incluido por Miguel 03/05/2023
                version_num:      count            &log &optional;
                ...
                # & Log incluido por Miguel a 14/05/2023, tambien he incluido &default = F
                client_key_exchange_seen: bool     &log &default=F;
                ## Track if the client sent a pre-shared-key extension.
                ## Used to determine if a TLS 1.3 session is being resumed.
                ## Not logged.
                # Original = F
                client_psk_seen: bool     &log &default=F;
                ...
                # -- &default = T incluido por miguel a 14/05/2023
                established:      bool             &log &default=T;
